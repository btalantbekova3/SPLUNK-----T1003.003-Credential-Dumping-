...
- 01-Windows_Security-Logs-Investigation (No indicators of compromise (No IOCs)) 
- 02-4688_WIndows_Secuity-logs-Investigation  (Has IOCs) 
- 03-Crowdstrike_Falcon-logs-Investigation (Has IOCs) 
- 04-Windows_Sysmon-Logs-Invesrigaton (Has non-direct IOCs) 
---
## Data Sources
